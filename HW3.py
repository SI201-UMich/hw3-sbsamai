...
class CouponDispenser:
    ...
    def issue_coupon(self, name):
        ...
        if name in self.customer_roster:
            name_already_exists = self.customer_roster.index(name)
            coupon_index = self.issued_indices[name_already_exists]
    ...
    def distribute_session(self):
        ...
        while True:
            user_input = input(
                f"Round {round_number} - Enter a name (or a comma_separated list), or type 'show' or 'exit': "
            )
